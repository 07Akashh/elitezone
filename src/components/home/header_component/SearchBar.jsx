...
const SearchBar = () => {
    ...
    return (
        <div className="relative border border-black sm:border-none p-2 sm:p-0 rounded-md">
            ...
            <div className="absolute left-0 right-0 sm:mt-2 mt-4 sm:w-[350px] w-full rounded-[10px] bg-white/80 sm:bg-white/40 backdrop-blur-[20px] shadow-lg max-h-60 overflow-y-auto z-10">
