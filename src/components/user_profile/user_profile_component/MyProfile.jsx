...
const MyProfile = () => {
    ...
    return (
        <div className='bg-white w-full px-[80px] py-[40px] font-TenorSans'>
            <h2 className="text-2xl mb-5 text-[#754F23] font-extralight">Edit Your Profile</h2>
            <div className="space-y-3">
                <form className='gap-5' onSubmit={handleSubmit}>
                    ...
                    <div className='mt-5 justify-end flex gap-5'>
                        ...
                        <button type="submit" className='h-[56px] w-[204px] bg-[#754F23] text-white text-base font-normal leading-normal rounded-md'>Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
