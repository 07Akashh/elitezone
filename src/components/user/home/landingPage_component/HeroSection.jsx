                        ...
                        <div key={category._id} className="group">
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 md:gap-3 lg:gap-4 relative z-10">
                                    <div className={`w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-lg md:rounded-xl flex items-center justify-center transition-all duration-300 ${
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <span className={`font-semibold line-clamp-1 transition-colors duration-300 text-sm md:text-base lg:text-lg ${
                                            hoveredCategory === index 
                                                ? 'text-primary' 
                                                : 'text-gray-800'
                                        }`}>
                                ...
                                <div className={`transition-all duration-300 ${openCategory === index ? '-rotate-90' : 'rotate-0'}`}>
                                    <MdOutlineArrowForwardIos className={`text-base md:text-lg lg:text-xl transition-colors duration-300 ${
                                        hoveredCategory === index 
                                            ? 'text-primary' 
                                            : 'text-gray-400'
                                    }`} />
                            ...
                            <div
                                className={`overflow-hidden transition-all duration-500 ease-in-out ${
                                    openCategory === index ? 'max-h-[300px] md:max-h-[400px] opacity-100' : 'max-h-0 opacity-0'
                                }`}
                            >
    ...
    const banners = [
        {
            ...
            description: "Explore our exclusive summer collection with up to 60% off on selected items",
            cta: "Shop Now",
            badge: "New Arrival"
        },
        {
            ...
            description: "Classic designs that never go out of style. Premium quality at affordable prices",
        ...
        },
        {
            ...
            description: "From statement jewelry to designer bags, find the perfect finishing touch",
