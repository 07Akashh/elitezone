        ...
        <div className='bg-none sm:py-[50px] sm:px-[100px] py-10 font-Poppins w-full xl:px-[135px] lg:px-[100px] md:px-[60px] px-[20px]'>
            <div className='grid lg:grid-cols-3 sm:grid-cols-3 grid-cols-1 mx-auto text-center text-[#555555] text-xl leading-tight gap-20'>
                ...
                <TbTruckDelivery className='h-20 w-20 bg-black text-text-inverse p-3 rounded-full border-8 border-white/50 mb-5 mx-auto' />
                    <p className='text-text1 text-xl font-semibold font-Poppins leading-7'>FREE AND FAST DELIVERY</p>
                    <p className='text-center text-text2 text-sm font-normal font-Poppins leading-[21px]'>Free delivery for all orders over Rs 2000</p>
                </div>
                <div>
