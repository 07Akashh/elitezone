    ...
    return (
        <div className='bg-[#F2F2F2] sm:py-[50px] sm:px-[100px] px-10 py-10 font-PlayfairDisplay w-full'>
            <div className='text-center mb-[35px]'>
                <h3 className='text-4xl font-semibold text-[#2f2f2f] mb-[30px] sm:mb-[40px]'>Brand</h3>
                <p className='text-[#555555] text-2xl font-normal leading-tight tracking-tight'>Making a luxurious lifestyle accessible for a generous group of women is our daily drive.</p>
            </div>
            <div className='grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 mx-auto text-center text-[#555555] text-xl leading-tight gap-20'>
                <div>
